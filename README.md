...
- **E Notation**  
  Displays numbers in scientific notation (example: -0.0000546 → -5.46e-5).
...
### General
- **What Does It Do?**  
  Strat Reminders are just reminders you can access at anytime to remind yourself of strategies. There is no logic past just the GUI itself.

### Showcase

![Strat Reminders Example](assets/strat_reminders.png)
...
### General
- **What Is It For?**  
  The strategy editor is used to define the inputs of a strategy for a jump tick by tick. Features such as Input Status and Perfect 45 Offset require you to have your strategy set for the jump you are currently doing.
...
- **Jump Config Buttons**
  ...
  - **Ceiling Button**: Sets a ceiling height for the jump. If the ceiling height you are looking for isn't there, just input the jump manually using Add Tick.

- **Show Tick #**  
  Displays a label that shows the tick # you are on. Increases by 1 every tick after moving after resetting.
...
[![Input Status Showcase 1](https://img.youtube.com/vi/Nl3VHL3SM0U/0.jpg)](https://www.youtube.com/watch?v=Nl3VHL3SM0U)

[▶ Watch Showcase 1](https://www.youtube.com/watch?v=Nl3VHL3SM0U)

[![Input Status Showcase 2](https://img.youtube.com/vi/McFBeERzFMo/0.jpg)](https://www.youtube.com/watch?v=McFBeERzFMo)
...
### Required Config
- **# of 45s**  
  Number of times you flick to +-45 in your jump. Must be less than or equal to the number of jumps in your strategy.
...
- **Fix Strat 45s**  
  This button fixes the 45 jumps of your strategy if they are wrong (you are notified if they are wrong on config GUI close). Note that this fix is based on your # of 45s, 45 key, and the position of the jump ticks in your strategy. If any of those 3 are wrong for your strategy, this button will not work, so fix those before you use this. Also note that this fix assumes you use tapping strafe for 1t instead of releasing strafe for 1t. If you use strafe releasing, either just put in your whole strategy manually, or just use this fix and then manually change the jump ticks in your strategy to be strafe releases instead of strafe taps.
...
- This feature only works if momentum is noturn for at least every tick your first 45 jump tick.
- Your # of 45s must be equal to or less than the number of jumps in your strategy.
- Your strategy must include the strafing and the A/D tapping you do while 45ing. If you use Fix Strat 45s, this is included automatically.
...
[![Perfect 45 Offset Showcase 1](https://img.youtube.com/vi/ogHvuFBKtuM/0.jpg)](https://www.youtube.com/watch?v=ogHvuFBKtuM)

[▶ Watch Showcase 1](https://www.youtube.com/watch?v=ogHvuFBKtuM)

[![Perfect 45 Offset Showcase 2](https://img.youtube.com/vi/tBZgtMyY9Es/0.jpg)](https://www.youtube.com/watch?v=tBZgtMyY9Es)
...
[![Trajectory Showcase](https://img.youtube.com/vi/WHZO3lhQV0o/0.jpg)](https://www.youtube.com/watch?v=WHZO3lhQV0o)
...
### Coordinate Limits
- **Min X**  
  Sets minimum player X coordinate required for position checkers to work.

- **Max X**  
  Sets maximum player X coordinate allowed for position checkers to work.

- **Min Z**  
  Sets minimum player Z coordinate required for position checkers to work.
...
[![Position Checkers Showcase](https://img.youtube.com/vi/WVmCx3AI-g4/0.jpg)](https://www.youtube.com/watch?v=WVmCx3AI-g4)
...
### General
- **What Does It Do?**  
  Turn Helper renders in-world targets according to certain yaw points set in config to help with turns.
...
- **Show Turn Accuracy**  
  Shows a label that displays how well you followed your yaw points (in %). Each tick it checks how many degrees your yaw was off by and calculates percentage linearly from that. If your yaw was 45 or more degrees off, it is treated as 0% for that tick. Note that turn accuracy is unaffected by Yaw +- (yaw +- is just for thickness of the target). Also note that this percentage doesn't reflect how close you are to making the jump, because some ticks in parkour are way more important to be accurate for making distance (like jump tick/jump angle).

- **Yaw Point Config Buttons**
  - Tick #: Tick #1 is the first tick that your position has changed from your reset position. Tick #2 is the tick after that, etc. Minimum tick # allowed for yaw points is Tick #2 because you never rotate on Tick #1 in parkour.
...
[![Turn Helper Showcase 1](https://img.youtube.com/vi/Wqt8_NIQyFM/0.jpg)](https://www.youtube.com/watch?v=Wqt8_NIQyFM)

[▶ Watch Showcase 1](https://www.youtube.com/watch?v=Wqt8_NIQyFM)

[![Turn Helper Showcase 2](https://img.youtube.com/vi/80jl_UemU5M/0.jpg)](https://www.youtube.com/watch?v=80jl_UemU5M)
