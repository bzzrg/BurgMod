...
public class P45OffsetConfig {
    ...
    public static void updateConfigFile() {
        ...
        setBool(CAT, "showLB", showLB);
        setBool(CAT, "showJumpBlock", showJumpBlock);
        setBool(CAT, "showJBLBLine", showJBLBLine);
        setBool(CAT, "showPerfectLine", showPerfectLine);
    ...
    public static void updateFields() {
        ...
        showLB = getBool(CAT, "showLB", showLB);
        showJumpBlock = getBool(CAT, "showJumpBlock", showJumpBlock);
        showJBLBLine = getBool(CAT, "showJBLBLine", showJBLBLine);
        showPerfectLine = getBool(CAT, "showPerfectLine", showPerfectLine);
