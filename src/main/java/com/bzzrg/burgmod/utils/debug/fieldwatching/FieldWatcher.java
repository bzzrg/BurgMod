package com.bzzrg.burgmod.utils.debug.fieldwatching;
...
import static com.bzzrg.burgmod.utils.debug.fieldwatching.FieldWatcherConfig.specs;
...
public class FieldWatcher {
    ...
    public static class FieldWriteTransformer implements IClassTransformer {
        ...
        private static final String WATCHER = "com/bzzrg/burgmod/utils/debug/fieldwatching/FieldWatcher";
